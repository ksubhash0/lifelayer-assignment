...
import useUploadImagee from "../hooks/useUploadImagee";
import { ToastContainer, toast } from 'react-toastify';
import { validateEmail, validateMobileNumber } from "../utils/validator";
import { createCandidate } from "../http";
...
export default function Add() {
    ...
    const { image, handleFile } = useUploadImagee()
    ...
    const handleAdd = async () => {
        ...
        try {
            ...
            createCandidate({
               ...
               educations,
               image: image == '/img/placeholder.jpg' ? false : image
            }),
            {
                    ...
                    <div className="card list-card">
                        ...
                        <div className="candate-detail form-section">
                            ...
                            
                            {
                                ...
                                <div className="input-group">
                                    ...
                                    <input className="input"  name="from" value={edu.from} onChange={(e) => handleChangeEdu(e, i)} type="date" id={`from${i}`} />
                                </div>
                                <div className="input-group">
                                    <label htmlFor={`to${i}`}>To</label><br />
                                    <input className="input" name="to" value={edu.to} onChange={(e) => handleChangeEdu(e, i)} type="date" id={`to${i}`} />
                                </div>
                            </div>
                        ...
                        <div className="candate-detail form-section">
                            ...
                            <div className="form-row-4">
                                ...
                                <div className="input-group">
                                    ...
                                    <input className="input" name="to" value={exp.to} onChange={(e) => handleChangeExp(e, i)} type="date" id={`eto${i}`} />
                                </div>
                            </div>
                            <div className="remove-field">
                        ...
                        <div className="candate-detail form-section">
                           ...
                           <div className="portfoio-preview">
                            <label htmlFor="port">
                            <img style={{width: '100%', height: '180px', objectFit: 'cover', borderRadius: '8px'}} src={image} alt="preview" />
                            </label>
                        ...
                        <div className="add-field">
                                <button onClick={handleAdd} className="btn-primary">Add Now</button>
                        </div>
